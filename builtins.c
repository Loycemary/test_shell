 ...
 * if no parameter it will change directory to home
...
/**
 * env_b - Prints all environment variables in the currrent shell.
 * @line: A string representing the inout from the user
 */
...
/**
 * check_built_ins - Findsthe right function needed for execution.
 * @str: The name of the function needed
 ...
 * @line: A string representing the input from the user
 * Return: If function is found 0, -1 otherwise.
 */
